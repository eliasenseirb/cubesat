...
#define BEACON_UUID "42f30a5c-70ca-40f2-8a5f-7f4caba149aa" // UUID 1 128-Bit (may use linux tool uuidgen or random numbers via https://www.uuidgenerator.net/)
...
void setBeacon()
{
  ...
  oAdvertisementData.setName("CubesatDDH");
...
void setup()
{
  ...
  // Start advertising
  pAdvertising->start();
  Serial.println("Advertizing started for 20s ...");
  delay(500);
  pAdvertising->stop();
  Serial.printf("enter deep sleep for 10s\n");
  esp_deep_sleep(100LL * GPIO_DEEP_SLEEP_DURATION);
